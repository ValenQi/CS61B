...
class Move {
    ...
    Direction direction() {
        int disc = _col1 - _col0, disr = _row1 - _row0;
        if (disr == 0 && disc == 0) {
            return NOWHERE;
        } else if (disr == 0 && disc > 0) {
            return E;
        } else if (disr == 0 && disc < 0) {
            return W;
        } else if (disc == 0 && disr > 0) {
            return N;
        } else if (disc == 0 && disr < 0) {
            return S;
        } else if (disc == disr && disc > 0) {
            return NE;
        } else if (disc == disr && disc < 0) {
            return SW;
        } else if (disc == -disr && disc > 0) {
            ...
            throw new IllegalArgumentException("Illegal moving direction.");
        }
    }
